...
namespace TrackX.Infrastructure.Persistences.Contexts.Configurations
{
    public class TbWhsConfiguration : IEntityTypeConfiguration<TbWhs>
    {
        ...
        {
            builder.HasKey(e => e.Id).HasName("PK__TB_WHS__3214EC07ADB85605");
            ...
            builder.Property(e => e.VinculacionOtroRegistro)
                .HasMaxLength(100)
                .IsUnicode(false);
            builder.Property(e => e.Documentoregistro)
                .IsUnicode(false);
            builder.Property(e => e.WHSReceipt)
                .IsUnicode(false);
            builder.Property(e => e.Imagen1)
                .IsUnicode(false);
            builder.Property(e => e.Imagen2)
                .IsUnicode(false);
            builder.Property(e => e.Imagen3)
                .IsUnicode(false);
            builder.Property(e => e.Imagen4)
                .IsUnicode(false);
            builder.Property(e => e.Imagen5)
                .IsUnicode(false);
        }
    }
}